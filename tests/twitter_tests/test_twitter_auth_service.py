...
class TestClassRequest:
    ...
    @pytest.mark.asyncio
    @responses.activate
    async def test_obtain_twitter_request_token_fail(self, client):
        #Mock the call to Twitter API
        responses.get(
            url='https://api.twitter.com/oauth/request_token',
            body='Unauthorized',
    ...
    @pytest.mark.asyncio
    @responses.activate
    async def test_obtain_twitter_request_token_error(self, client):
        #Mock the call to Twitter API
        responses.get(
            url='https://api.twitter.com/oauth/request_token',
            status=200
...
class TestClassAuthorization:
    ...
    @pytest.mark.asyncio
    @responses.activate
    async def test_obtain_twtter_access_token_fail(self, client):
        #Mock Twitter API Call
        responses.post(
            url='https://api.twitter.com/oauth/access_token',
            body='Unauthorized',
    ...
    @pytest.mark.asyncio
    @responses.activate
    async def test_obtain_twtter_access_token_error(self, client):
        #Mock Twitter API Call
        responses.post(
            url='https://api.twitter.com/oauth/access_token',
            status=200
